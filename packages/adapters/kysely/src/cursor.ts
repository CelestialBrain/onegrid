...
//
// Self-contained per the architectural guardrail in CONTRIBUTING.md:
// adapters depend only on `@onegrid/protocol`. Wire format identical
// to the Drizzle adapter so a server using one can serve clients
// using the other transparently.
// =============================================================================
